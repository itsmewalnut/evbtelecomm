...
if ($network_type == "Globe") {
    if ($action == 'AddGlobe') {
        mysqli_query($conn, "INSERT INTO globe_table(account_no, register_no, register_name, branch, duedate, account_type, acquisition_date, register_address, username, password, monthly, email, phone, serial_no, imei1, imei2, account_status, final_status) VALUES ('$accountNO', '$registerNO', '$registerName', '$acc_Branch', '$dueDate', '$acc_type', '$acqui_date', '$register_add', '$account_username', '$account_password', '$accMonthly', '$accEmail', '$accPhone', '$acc_serialno', '$accImei1', '$accImei2', '$accountStatus', '$finalStatus')");
