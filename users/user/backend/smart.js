...
$("#addSmart").on("hidden.bs.modal", function () {
  $(':input[type="submit"]').prop("disabled", false);
  $("#addSmart-title").text("Add New Account");
  $("#fname").text("");
  $(".textive").removeClass("focused is-focused");
  $("#imagePreview").attr("src", "");
  $("#addSmart_form")[0].reset();
...
// Add Account
$(document).on("click", "#AddNewSmart", function () {
  $("#action").val("AddSmart");
  $(".main-content").removeClass("ps ps--scrolling-y");
});

// Add Account query
$("#addSmart_form").submit(function (e) {
