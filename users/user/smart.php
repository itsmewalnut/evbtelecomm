...
?>
    ...
    <body class="g-sidenav-show bg-gray-200">
        ...
        <main
                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Smart</li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Smart</h6>
                    </nav>
            ...
            <!-- Add Account Modal -->
            <div class="modal fade" id="addSmart" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-normal" id="addSmart-title">Add New Account</h5>
                            <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="addSmart_form" enctype="multipart/form-data" method="post">
                                <div class="row mt-4">
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group input-group-static mb-4 textive">
                                                            ...
                                                            <input type="text" name="smart_username" id="smart_username" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="input-group input-group-static mb-4 textive">
                                                            <label>Password</label>
                                                            <input type="text" name="smart_password" id="smart_password" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="input-group input-group-static mb-4 textive">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="hidden" name="networkType" id="networkType" value="Smart">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="payment_form" enctype="multipart/form-data" method="post">
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-static mb-4 textive">
                                            ...
                                            <input type="number" name="paid_amount" id="paid_amount" class="form-control" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                                <h5>Attachments</h5>
                                ...
                                <div class="input-group input-group-dynamic">
                                    <textarea class="multisteps-form__textarea form-control" rows="3" name="paid_remarks" id="paid_remarks" placeholder="Say a few words about your remarks"></textarea>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn bg-gradient-secondary" data-bs-target="#viewSmart" data-bs-toggle="modal">Back</button>
                                <button type="submit" id="submit_payment" class="btn bg-gradient-warning">Paid</button>
                                <input type="hidden" name="paid_type" id="paid_type" value="paidSmart">
            ...
            <!----------------------------------------Transmit Modal------------------------------------->
            <div class="modal fade" id="transmitModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Transmit Account</h5>
                            <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form id="TransmitForm" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="hidden" name="transmitSmartID" id="transmitSmartID">
                            </div>
                        </form>
                    </div>
                </div>
