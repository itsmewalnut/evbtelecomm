                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Pldt</li>
                        </ol>
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
                    <div class="modal-content">
                                    ...
                                    <div class="mx-auto position-relative">
                                        <div class="card">
                                            <div class="card-header p-0 position-relative mt-n4 mx-2 z-index-2">
                                                <div class="bg-gradient-danger shadow-danger border-radius-lg py-2 pe-1">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="hidden" name="networkType" id="networkType" value="Pldt">
